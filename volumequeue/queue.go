...
func (timerSource) NewTimer(attempt uint) vqTimer { _ = "STUB: not implemented"; return *new(vqTimer) }
...
func NewVolumeQueue() *VolumeQueue { _ = "STUB: not implemented"; return nil }
...
func (vq *VolumeQueue) Wait() (string, uint) { _ = "STUB: not implemented"; return "", 0 }
...
func (vq *VolumeQueue) Outstanding() int { _ = "STUB: not implemented"; return 0 }

// Stop stops the volumeQueue and cancels all outstanding entries. stop may
// only be called once.
func (vq *VolumeQueue) Stop() { _ = "STUB: not implemented"; return }

...
func New(store *store.MemoryStore) *TaskReaper { _ = "STUB: not implemented"; return nil }
...
func (tr *TaskReaper) Run(ctx context.Context) { _ = "STUB: not implemented"; return }
...
func taskInTerminalState(task *api.Task) bool { _ = "STUB: not implemented"; return false }

// taskWillNeverRun returns true if task will never reach running state.
func taskWillNeverRun(task *api.Task) bool { _ = "STUB: not implemented"; return false }
...
func (tr *TaskReaper) Stop() { _ = "STUB: not implemented"; return }
